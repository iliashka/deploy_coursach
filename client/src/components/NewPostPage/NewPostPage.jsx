...
function NewPostPage({ user, tags, setTags, lang }) {
    ...
    return (
        <div className="card border-secondary mb-3 newPostCard" style={{ maxWidth: '60%', margin: 'auto', marginTop: '5rem' }}>
            ...
            <button onClick={() => NewPostLogic.newPostHandler(preTags, value, newPost, user)} data-bs-toggle="modal" data-bs-target="#exampleModal" className='btn btn-primary'><h5>{lang===false?`Post it`:`Опубликовать`}</h5></button>
